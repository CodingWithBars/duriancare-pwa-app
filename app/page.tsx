...
import { Camera, History, Leaf, ChevronRight, Image as ImageIcon, Info, X, Target, Cpu, ThermometerSun, Calendar } from "lucide-react";
...
export default function Home() {
  ...
  // FIXED: Logic to ensure we pull the freshest data
  useEffect(() => {
    const loadData = () => {
    ...
    loadData();
    // Optional: Listen for storage changes if you scan and come back
        ...
        <section className="flex flex-col">
          ...
          <div className="space-y-3">
            {history.length === 0 ? (
              ...
              // Slice first 3 items from the already sorted history
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                      <div className="flex justify-between text-[11px] font-black text-slate-700 uppercase">
                        <span className="flex items-center gap-1.5">CNN Analysis <span className="text-[9px] text-slate-400 font-medium lowercase">(texture)</span></span>
                    ...
                    <div className="space-y-1.5">
                      <div className="flex justify-between text-[11px] font-black text-slate-700 uppercase">
                        <span className="flex items-center gap-1.5">ViT Analysis <span className="text-[9px] text-slate-400 font-medium lowercase">(spatial/color)</span></span>
